...
class AemsEngagementResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'requestingOfficeId' => $this->requesting_office_id,
            ...
            'specialAuthorityReceivedDate' => $this->special_authority_received_date?->toDateString(),
            ...
            'periodCoveredStartDate' => $this->period_covered_start_date?->toDateString(),
            'periodCoveredEndDate' => $this->period_covered_end_date?->toDateString(),
            ...
            'requestingOffice' => $this->whenLoaded(
                'requestingOffice',
                fn () => $this->requestingOffice ? [
                    'id' => $this->requestingOffice->id,
                    'code' => $this->requestingOffice->code,
                    'name' => $this->requestingOffice->name,
                ] : null,
            ),
            'specialAuthorityDocument' => $this->whenLoaded(
                'specialAuthorityDocumentVersion',
                fn () => $this->specialAuthorityDocumentVersion ? [
                    'id' => $this->specialAuthorityDocumentVersion->id,
                    'fileName' => $this->specialAuthorityDocumentVersion->original_file_name,
                    'mimeType' => $this->specialAuthorityDocumentVersion->mime_type,
                    'fileSize' => $this->specialAuthorityDocumentVersion->file_size,
                    'checksumSha256' => $this->specialAuthorityDocumentVersion->checksum_sha256,
                ] : null,
            ),
