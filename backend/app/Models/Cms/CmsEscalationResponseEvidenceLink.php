...
class CmsEscalationResponseEvidenceLink extends Model
{
    use HasFactory;
    ...
    public function responseVersion(): BelongsTo
    {
        return $this->belongsTo(CmsEscalationResponseVersion::class, 'cms_escalation_response_version_id');
    }
